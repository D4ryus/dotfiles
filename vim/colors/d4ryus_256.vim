...
" Generated by http://bytefluent.com/vivify 2014-06-23
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Folded guifg=#5e7070 guibg=#000000 guisp=#000000 gui=bold ctermfg=66 ctermbg=NONE cterm=bold
...
hi Normal guifg=#628787 guibg=#000000 guisp=#000000 gui=NONE ctermfg=66 ctermbg=NONE cterm=NONE
...
hi Comment guifg=#474f4f guibg=NONE guisp=NONE gui=italic ctermfg=239 ctermbg=NONE cterm=NONE
...
hi PMenu guifg=#839496 guibg=#121212 guisp=#121212 gui=NONE ctermfg=66 ctermbg=233 cterm=NONE
...
hi TabLine guifg=#839496 guibg=#121212 guisp=#121212 gui=underline ctermfg=66 ctermbg=233 cterm=underline
