...
call s:hibg("Search"    ,"#ff0000","DarkRed",1)
highlight IncSearch     guifg=White guibg=Black ctermfg=White ctermbg=Black
highlight MoreMsg       guifg=#00AA00 ctermfg=Green
highlight LineNr        guifg=#DDEEFF ctermfg=DarkGray
call s:hibg("LineNr"    ,"#222222","DarkGray",80)
call s:hibg("SignColumn","#222222","darkGray",80)
...
highlight Pmenu         guifg=White ctermfg=White gui=bold cterm=bold,underline
highlight PmenuSel      guifg=White ctermfg=White gui=bold cterm=bold,underline
